  ...
  return (
    <a
      ...
      className={cn(
        ...
        "bg-[#7ec85a] font-bold uppercase tracking-[0.12em] shadow-[0_0_18px_rgba(100,175,90,0.28),0_8px_24px_-8px_rgba(0,0,0,0.35)]",
        "hover:bg-[#6aaf4a] hover:shadow-[0_0_22px_rgba(100,175,90,0.35)] active:scale-[0.98]",
        "focus-visible:ring-2 focus-visible:ring-[#7ec85a]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0c0d12]",
        variant === "section" &&
